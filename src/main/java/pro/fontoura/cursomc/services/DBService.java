...
public class DBService {
	...
	public boolean instantiateDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "contato@investimentoedivida.com.br", "36378912377", TipoPessoa.PESSOAFISICA);
		
		cli1.getTelefone().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "dalmer@investimentoedivida.com.br", "31628382740", TipoPessoa.PESSOAFISICA);
